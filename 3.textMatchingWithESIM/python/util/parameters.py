...
test_matched = "../../../../data/multinli_1.0/multinli_1.0_test_matched.jsonl".format(args.datapath)


if os.path.isfile(test_matched):
    test_matched = "../../../../data/multinli_1.0/multinli_1.0_dev_matched.jsonl".format(args.datapath) #"{}/multinli_0.9/multinli_0.9_test_matched.jsonl".format(args.datapath)
    test_mismatched = "../../../../data/multinli_1.0/multinli_1.0_dev_mismatched.jsonl".format(args.datapath) #"{}/multinli_0.9/multinli_0.9_test_mismatched.jsonl".format(args.datapath)
    test_path = "../../../../data/multinli_1.0".format(args.datapath)
else:
    test_path = "../../../../data/multinli_1.0".format(args.datapath)
    temp_file = os.path.join(test_path, "temp.jsonl")
    io.open(temp_file, "wb")
...
def load_parameters():
    FIXED_PARAMETERS = {
        ...
        "training_mnli": "../../../../data/multinli_1.0/multinli_1.0_train.jsonl".format(args.datapath),
        "dev_matched": "../../../../data/multinli_1.0/multinli_1.0_dev_matched.jsonl".format(args.datapath),
        "dev_mismatched": "../../../../data/multinli_1.0/multinli_1.0_dev_mismatched.jsonl".format(args.datapath),
        "test_matched": test_matched,
        "test_mismatched": test_mismatched,
        "training_snli": "../../../../data//snli_1.0/snli_1.0_train.jsonl".format(args.datapath),
        "dev_snli": "../../../../data//snli_1.0/snli_1.0_dev.jsonl".format(args.datapath),
        "test_snli": "../../../../data//snli_1.0/snli_1.0_test.jsonl".format(args.datapath),
        "embedding_data_path": "../../../glove/glove.42B.300d.txt".format(args.datapath),
